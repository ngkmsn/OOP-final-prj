...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "hust@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to HUST Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with HUST Electronics.<br>"
					...
					+ "<span class='greenText'>HUST500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
