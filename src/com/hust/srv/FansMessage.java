...
import com.hust.utility.MailMessage;
...
public class FansMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Message to HUST Electronics</h2>" + ""
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("nguyenkimson0805@gmail.com", "Fans Message | " + name + " | " + email,
				htmlTextMessage);
